...
<div class="col-sm-9 col-md-10 text-center ">
    <p class="bg-dark text-white  mt-5 p-2">List of Requester</p>
    <?php   $sql = "SELECT * FROM `user`";
                    ...
                    if($result->num_rows > 0){
                        echo'<table class="table mt-3 mr-5">
                             ...
                             echo '<input type="hidden" name="id" value='.$row["uid"].'><button class="btn btn-info" 
                             name ="edit" value ="Edit" type="submit"><i class="fas fa-pen"></i></button>';
                             echo '</form>';
                             echo '<form action="" method="post" class="d-inline mr-2">';
                             echo '<input type="hidden" name="id" value='.$row["uid"].'><button class="btn btn-secondary" 
...
<div class="float-right"><a href="insert.php" class="btn btn-primary mx-3 mb-5"><i class="fa fa-plus "></i></a></div>
 </div>
